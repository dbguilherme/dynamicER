...
class ConcurrentBlockingService(size1: Int, size2: Int = 0, ro: Double = 0.005, ff: Double = 0.01) {
...
object ConcurrentBlockingService {
  ...
  private def getAssociatedBlocks(idx: Int, dId: Int, textModelTokens: List[String], maxBlockSize: Array[Double]) = {
