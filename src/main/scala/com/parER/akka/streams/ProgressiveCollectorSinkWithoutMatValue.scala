...
class ProgressiveCollectorSinkWithoutMatValue(t0: Long, t1: Long, dp: AbstractDuplicatePropagation, print: Boolean = true) extends GraphStage[SinkShape[List[Comparison]]] {
  val in: Inlet[List[Comparison]] = Inlet("ProgressiveCollectorSinkWithoutMatValue")
